                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <>
                        ...
                        <View style={styles.footer}>
                            <TextInput placeholder="Signal Message" value={input} style={styles.textInput} onChangeText={text => setInput(text)} onSubmitEditing={sendMessage} />
...
const styles = StyleSheet.create({
    ...
    textInput: {
        ...
        bottom: 0,
        height: 40,
        // take up as much room as you can horizonally
        flex: 1,
        marginRight: 15,
